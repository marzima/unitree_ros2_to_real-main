...
def generate_launch_description():
    ...
    twist_driver_controlsquare_node = Node(
        package='unitree_ros2_to_real_main',
        executable='twist_driver_controlsquare',
        name='twist_driver_controlsquare_node',
        parameters=[
            {
                "start_walking": True,
    ...
    ld.add_action(twist_driver_controlsquare_node)
