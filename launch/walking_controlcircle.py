...
def generate_launch_description():
    ...
    twist_driver_controlcircle_node = Node(
        package='unitree_ros2_to_real_main',
        executable='twist_driver_controlcircle',
        name='twist_driver_controlcircle_node',
        parameters=[
            {
                "start_walking": True,
    ...
    ld.add_action(twist_driver_controlcircle_node)
