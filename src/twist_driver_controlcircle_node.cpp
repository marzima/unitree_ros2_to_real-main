...
class TwistDriverControlCircle : public rclcpp::Node
{
public:
    TwistDriverControlCircle() : Node("a1_twist_driver_controlcircle_node")
    {
        // ROS parameters
        ...
        change_mode_srv_ = this->create_service<std_srvs::srv::Trigger>(
            "/change_mode",
            std::bind(&TwistDriverControlCircle::changeMode, this, std::placeholders::_1, std::placeholders::_2));
    }
...
int main(int argc, char *argv[])
{
    ...
    auto node = std::make_shared<TwistDriverControlCircle>();
